...
This page and the accompanying [Jupyter notebook](http://localhost:8080/attention-is-all-you-need)
...
German-English translation (in the paper they did this for English-German and English-French).
...
Since the newstest2013 dev/validation set is a bit short (3000K pairs), 80K pairs are sampled from
the training set and will be used as the main validation set during training.
